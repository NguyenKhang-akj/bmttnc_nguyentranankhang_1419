...
def md5(message):
    ...
    for i in range(0, len(message), 64):
        ...
        for j in range(64):
            ...
            d = c
            c = b
            b = (b + left_rotate((a + f + [0, 0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC][j // 16] + words[g]) & 0xFFFFFFFF, 3)) & 0xFFFFFFFF
            a = temp

        # Cập nhật các hằng số ban đầu
        a = (a + a0) & 0xFFFFFFFF
        b = (b + b0) & 0xFFFFFFFF
        c = (c + c0) & 0xFFFFFFFF
        d = (d + d0) & 0xFFFFFFFF
...
# Nhập chuỗi và tính băm MD5
input_string = input("Nhập chuỗi cần băm: ")
md5_hash = md5(input_string.encode('utf-8'))
print(f"MD5 băm của chuỗi '{input_string}': {md5_hash}")